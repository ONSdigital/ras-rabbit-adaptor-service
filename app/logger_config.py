...
def logger_initial_config(service_name=None,
    ...
    :type logger: String
    :param log_level: A string or integer corresponding to a Python logging lvl
    :type log_level: String
    :param logger_format: A string defining the format of the logs
    :type log_level: String
    :param logger_date_format: A string defining the format of the date/time in
     the logs
    :type log_level: String
    :rtype: None
    '''
...
logging.getLogger('sdc.rabbit').setLevel('ERROR')
logging.getLogger('sdc.crypto').setLevel('ERROR')
